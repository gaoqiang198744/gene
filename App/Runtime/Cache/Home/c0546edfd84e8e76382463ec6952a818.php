...
<div class="form">
	<form method='post' id="form_do" name="form_do" action="<?php echo U('Member/name');?>">		
		<div class="h3">昵称修改</div>
		<dl>
			<dt>邮箱：</dt>
		...
		<dl>
			<dt>昵称：</dt>
			<dd>
				<input type="text" name="nickname" class="inp_one"  value="<?php echo ($user["nickname"]); ?>" />
			</dd>
		</dl>
