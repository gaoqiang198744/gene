...
class Page{
    ...
    public function show() {
        ...
        $up_page = $up_row > 0 ? '<li class="preview"><a href="' . $this->url($up_row) . '">' . $this->config['prev'] . '<span> </span></a></li>' : '';
        //下一页
        $down_row  = $this->nowPage + 1;
        //$down_page = ($down_row <= $this->totalPages) ? '<a class="next" href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a>' : '';
        $down_page = ($down_row <= $this->totalPages) ? '<li class="next"><a href="' . $this->url($down_row) . '">' . $this->config['next'] . '<span> </span></a></li>' : '';
        //第一页
        $the_first = '';
        ...
        $page_str = str_replace(
            ...
            $this->config['theme']);//print_r($page_str);
